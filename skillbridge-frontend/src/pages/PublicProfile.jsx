  ...
  if (!profile) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#F7F8F4] px-4">
        <div className="max-w-md rounded-2xl border border-emerald-900/10 bg-white p-10 text-center shadow-[0_20px_56px_rgba(16,24,40,0.08)]">
          <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-xl bg-emerald-50 text-emerald-800">
            <UserRound size={30} aria-hidden="true" />
          </div>
          <h2 className="mb-2 text-2xl font-semibold tracking-tight text-gray-950">Profile Not Found</h2>
          <p className="mb-6 text-gray-600">This user profile could not be found</p>
          <Link
            to="/gigs"
            className="inline-flex items-center gap-2 px-1 py-2 text-sm font-medium text-emerald-700 transition-all hover:translate-x-1 hover:text-emerald-900"
          >
            ...
            <section className="rounded-2xl border border-emerald-900/10 bg-white p-6 shadow-[0_16px_38px_rgba(16,24,40,0.06)] sm:p-7">
              <div className="mb-5 flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2 className="text-2xl font-semibold tracking-tight text-gray-950">What they can help with</h2>
                </div>
              </div>
        ...
        <section className="mt-6 rounded-2xl border border-emerald-900/10 bg-white p-6 shadow-[0_16px_38px_rgba(16,24,40,0.06)] sm:p-7">
              ...
              {reviews.length === 0 ? (
                <div className="rounded-xl border border-dashed border-emerald-900/20 bg-emerald-50/50 px-6 py-12 text-center">
                  ...
                  <p className="mt-1 text-sm text-gray-500">This user hasn't received any reviews</p>
                </div>
              ) : (
